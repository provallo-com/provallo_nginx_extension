...
namespace provallo
{
	...
	struct random_split : public continous_base
	{
		...
		explicit random_split(std::random_device &random) : _ran()
		{
		}
	...
	class cont1d : public split_method, public SplittingPolicy
	{
		...
		cont1d(const cont1d &other) : split_method(other.getFactoryTag(),
												   std::vector<attribute_tag>(1, other.get_tag(0))),
									  _interval(
										  other._interval)
		{
	...
	public:
		...
		split_method_factory(const split_method_factory &other) : _split_methods(other._split_methods),
																  ...
																  r_dataset(other.r_dataset),override_split_method(false)
		{
		}
